...
function enqueue_scripts() {
	...
	wp_register_style( 'really-good-faq-style-1' , plugins_url( 'assets/css/style-1.min.css', Really_Good_FAQ()->file ), array(), Really_Good_FAQ()->version );
	wp_register_style( 'really-good-faq-style-2' , plugins_url( 'assets/css/style-2.min.css', Really_Good_FAQ()->file ), array(), Really_Good_FAQ()->version );
	wp_register_style( 'really-good-faq-style-3' , plugins_url( 'assets/css/style-3.min.css', Really_Good_FAQ()->file ), array(), Really_Good_FAQ()->version );
	wp_register_style( 'really-good-faq-style-4' , plugins_url( 'assets/css/style-4.min.css', Really_Good_FAQ()->file ), array(), Really_Good_FAQ()->version );
}
    ...
    ?><script type="text/javascript">
		(function() {
			...
			var hash = window.location.hash.substring(1),
				openQuestion = document.getElementById(hash);

			console.log(openQuestion)
			if (openQuestion) {
				openQuestion.classList.add('open');
			}
